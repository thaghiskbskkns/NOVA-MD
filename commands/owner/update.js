...
const UPDATE_ZIP_URL = 'https://github.com/thaghiskbskkns/NOVA-MD/archive/refs/heads/main.zip';
...
module.exports = {
  ...
  async execute(sock, msg, args, extra) {
    ...
    // Use provided URL or fall back to embedded URL
    const zipUrl = (args[0] || UPDATE_ZIP_URL).trim();

    if (!zipUrl) {
      return extra.reply('❌ No update URL configured. Please contact the bot owner.');
    }
